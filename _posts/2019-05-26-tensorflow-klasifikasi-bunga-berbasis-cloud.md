...
Sebenarnya artikel yang akan saya tulis masih berhubungan dari yang <a rel="noreferrer noopener" aria-label="sebelumnya (opens in a new tab)" href="/tensorflow-custom-object-detection-api-cloud/" target="_blank">sebelumnya</a>, jadi langkah-langkah nanti ada kelanjutan dari yang sebelumnya. Jika temen-temen belum melihat artikel saya sebelumnya, sebaiknya membaca terlebih dahulu. Jadi yang akan kita bahas adalah mengklasifikasi citra bunga(daisy, dandelion, roses, sunflowers, tulips) dengan model yang sebelumnya sudah kita training on cloud memanfaatkan layanannya Google Cloud Platform menggunakan tensorflow.
